...
Usage examples:
  python tools/check_len_consistency.py --video-root data/Surgery/frames --target-root data/Surgery/targets --chunk-size 32
  python tools/check_len_consistency.py --video-root /path/to/frames --target-root /path/to/targets --chunk-size 16 --sessions sessions.txt
"""
import argparse
import os
import sys
